...
class CompDec{
    ...
    std::shared_ptr<file_vector<sub<subchunk_size>>> Get_file()
    {
    return vec2;
    }
...
=======
    unsigned int n=30000000,_chunksize,page_size;
>>>>>>> 3bb4c2199c7a02acbddf4e3498b2bc86e48112fa
	...
	std::shared_ptr<file_vector<sub<4096>>> vec2=A.Get_file();
